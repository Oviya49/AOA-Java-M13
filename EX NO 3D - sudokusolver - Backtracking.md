...
# DATE: 25/8/2026
## AIM:
Write a Java program to solve a Sudoku puzzle by filling in the empty cells.
...
3. Try placing digits 1–9 and check if the placement is safe (row, column, and 3×3 box).

4. If safe, place the number and recursively solve the next cell; if not, backtrack.

5. Continue until the board is filled and display the solved Sudoku. 
...
## Result:
The program was implemented successfully, and the expected output was verified.
