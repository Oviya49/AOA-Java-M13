...
3. Check if the current position is safe (no queen in the row, upper-left, or lower-left diagonal).
...
## Result:
The program was successfully implemented, and the output was verified. 
